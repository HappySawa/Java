...
public class Main {
    public static void main(String[] args) {
        GenericClass<Integer, Float, String> genericClass = new GenericClass<>(10, 52f , "Hello");
        ...
        System.out.println("Sum: " + Calculator.sum(13, 3.5));
        System.out.println("Multiply: " + Calculator.multiply(5, 4));
